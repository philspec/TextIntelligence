...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"sentiment-analysis1"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
		...
		>
			...
			>
				This cognitive service by Azure can read unstructured data and answer questions related to the information available in the text provided. This is one of many text analysis services provided by Microsoft Azure in the form of simple APIs and SDKs which are scalable.
			</Text>
		</Box>
		<Link
			font={"--capture"}
